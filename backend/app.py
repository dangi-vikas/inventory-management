...
conf = ConnectionConfig(
    MAIL_USERNAME = "vikas.899.dangi@gmail.com" , #credentials['EMAIL']
    MAIL_PASSWORD = "Iamkd=dcd", #credentials['PASS'],
    MAIL_FROM = "vikas.899.dangi@gmail.com", #credentials['EMAIL']
    MAIL_PORT = 587,
